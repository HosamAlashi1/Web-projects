...
$quize_id = $_GET['id'];
$sql = "select * from quize where id=" . $quize_id;
...
if (isset($_POST['Update'])) {
    ...
    $sql = "update quize set nameSub = '$nameSub', startTime = '$startTime', endTime = '$endTime' where id= $quize_id";
                ...
                <div class="form-content">
                    <div class="form-items">
                        ...
                        <form class="requires-validation" novalidate action="<?php $_SERVER["PHP_SELF"]; ?>" method="POST">
                            ...
                            <div class="col-md-12">
                                <input class="form-control" type="text" name="name" placeholder="Subject Name" value="<?php echo $nameSub; ?>" required>
                                <div class="valid-feedback">Username field is valid!</div>
                                <div class="invalid-feedback">Username field cannot be blank!</div>
                            </div><br>

                            <div class="col-md-12">
                                <input class="form-control" type="datetime-local" name="startTime" value="<?php echo $startTime; ?>" required>
                                <div class="valid-feedback">startTime field is valid!</div>
                                <div class="invalid-feedback">startTime field cannot be blank!</div>
                            </div><br>

                            <div class="col-md-12">
                                <input class="form-control" type="datetime-local" name="endTime" value="<?php echo $endTime; ?>" required>
